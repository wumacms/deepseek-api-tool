...
<template>
  ...
  >
    <!-- Tab 切换头部 -->
    <div class="flex gap-2 border-b border-white/10 pb-3 shrink-0">
      <button
        @click="activeTab = 'history'"
        :class="[activeTab === 'history' ? 'text-blue-400 border-blue-500/40 bg-blue-500/10 font-bold' : 'text-gray-400 border-transparent hover:text-white hover:bg-white/5 font-semibold']"
      ...
      <button
        ...
        :class="[activeTab === 'settings' ? 'text-blue-400 border-blue-500/40 bg-blue-500/10 font-bold' : 'text-gray-400 border-transparent hover:text-white hover:bg-white/5 font-semibold']"
        class="flex-1 flex items-center justify-center gap-1.5 py-2 text-xs rounded-none border transition-all cursor-pointer"
      >
    ...
    <div v-show="activeTab === 'settings'" class="flex-1 flex flex-col gap-4 overflow-y-auto pr-1">
      ...
      <!-- Token Usage Metrics -->
      <div v-if="latestUsage" class="border-t border-white/10 pt-3 mt-auto flex flex-col gap-2 shrink-0">
